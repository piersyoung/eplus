  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved postcode as @postcode" do
        ...
        post :create, {:postcode => { "code" => "invalid value" }}, valid_session
        assigns(:postcode).should be_a_new(Postcode)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested postcode" do
        ...
        Postcode.any_instance.should_receive(:update_attributes).with({ "code" => "MyString" })
        put :update, {:id => postcode.to_param, :postcode => { "code" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the postcode as @postcode" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Postcode.any_instance.stub(:save).and_return(false)
        put :update, {:id => postcode.to_param, :postcode => { "code" => "invalid value" }}, valid_session
        assigns(:postcode).should eq(postcode)
      end
