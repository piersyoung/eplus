  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved form as @form" do
        ...
        post :create, {:form => { "name" => "invalid value" }}, valid_session
        assigns(:form).should be_a_new(Form)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested form" do
        ...
        Form.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => form.to_param, :form => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the form as @form" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Form.any_instance.stub(:save).and_return(false)
        put :update, {:id => form.to_param, :form => { "name" => "invalid value" }}, valid_session
        assigns(:form).should eq(form)
      end
